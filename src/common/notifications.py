...
class NotificationManager:
    ...
    def send_error_notification(self, error_message: str, module: str = "Sistema") -> bool:
        """
...
def send_notification(message: str, notification_type: str = "info") -> bool:
    ...
    if notification_type == "error":
        ...
        return manager.send_email([manager.default_recipient], "Notificación del Sistema", message)
