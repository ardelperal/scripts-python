...
class TestEmailRecipientsService(unittest.TestCase):
    ...
    @patch('common.email.recipients_service._utils.get_admin_emails_string', return_value='a@b;c@d')
    ...
    @patch('common.email.recipients_service._utils.get_technical_emails_string', return_value='tec1@test;tec2@test')
    ...
    @patch('common.email.recipients_service._utils.get_quality_emails_string', return_value='q1@test;q2@test')
