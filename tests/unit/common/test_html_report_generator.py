...
def test_tabla_nc_pendientes_eficacia_color_classes():
    ...
    rows = [
        {
            "CodigoNoConformidad": "A",
            "Nemotecnico": "NA",
            "DESCRIPCION": "D",
            "RESPONSABLECALIDAD": "R",
            "FECHACIERRE": datetime.date(2025, 1, 1),
            "FechaPrevistaControlEficacia": datetime.date(2025, 2, 1),
            "Dias": -1,
        },
        {
            "CodigoNoConformidad": "B",
            "Nemotecnico": "NB",
            "DESCRIPCION": "D",
            "RESPONSABLECALIDAD": "R",
            "FECHACIERRE": datetime.date(2025, 1, 1),
...
def test_generar_reporte_tecnico_moderno_partial():
    ...
    ars_15 = [
        {
            "CodigoNoConformidad": "X",
            "Nemotecnico": "NX",
            "AccionCorrectiva": "AC",
            "AccionRealizada": "AR",
            "FechaInicio": datetime.date(2025, 1, 1),
            "FechaFinPrevista": datetime.date(2025, 1, 10),
            "Nombre": "Tec",
            "DiasParaCaducar": 4,
            "CorreoCalidad": "c@x",
        }
    ...
    assert (
        "Acciones Correctivas con fecha fin prevista a 1-7 días" not in html
        or html.count("<table") == 2
    )  # header + 1 tabla
...
def test_generar_notificacion_individual_arapc():
    gen = HTMLReportGenerator()
    arapc = {
        "CodigoNoConformidad": "NC9",
        "AccionRealizada": "Revisar",
        "dias_restantes": 2,
        "FechaFinPrevista": datetime.datetime(2025, 1, 15),
    }
    user = {"correo": "user@x"}
    ...
    rows = [
        {
            ...
            "AccionRealizada": "A1",
            "Responsable": "R1",
            "FechaFinPrevista": now - datetime.timedelta(days=2),
        },  # vencida
        {
            "IDAccionRealizada": 2,
            "CodigoNoConformidad": "NC2",
            "AccionRealizada": "A2",
            "Responsable": "R2",
            "FechaFinPrevista": now + datetime.timedelta(days=3),
        },  # <=7
        {
            "IDAccionRealizada": 3,
            "CodigoNoConformidad": "NC3",
            "AccionRealizada": "A3",
            "Responsable": "R3",
            "FechaFinPrevista": now + datetime.timedelta(days=15),
        },  # >7
    ]
    ...
    rows = [
        {
            ...
            "RESPONSABLECALIDAD": "R",
            "FECHAAPERTURA": datetime.datetime(2025, 1, 1),
            "FPREVCIERRE": datetime.datetime(2025, 1, 10),
            "DiasParaCierre": -3,
            "dias_para_cierre": -3,
        },
        {
        ...
        },
        {
            ...
            "RESPONSABLECALIDAD": "R",
            "FECHAAPERTURA": datetime.datetime(2025, 1, 1),
            "FPREVCIERRE": datetime.datetime(2025, 2, 1),
            "DiasParaCierre": 12,
            "dias_para_cierre": 12,
        },
    ]
    ...
    rows = [
        {
            ...
            "RESPONSABLECALIDAD": "Resp",
            "FechaApertura": datetime.datetime(2025, 1, 1),
            "FechaPrevistaCierre": datetime.datetime(2025, 1, 20),
        }
    ]
...
def test_generar_resumen_estadisticas_conteos():
    ...
    ncs_eficacia = [{}]  # 1
    arapcs = [
        {"FechaFinPrevista": now - datetime.timedelta(days=1)},
        {"FechaFinPrevista": now + datetime.timedelta(days=5)},
    ]  # 2, 1 vencida
    ncs_caducar = [{"dias_para_cierre": -1}, {"dias_para_cierre": 3}]  # 1 caducada
    ncs_sin_acciones = [{}, {}]  # 2
    html = gen.generar_resumen_estadisticas(
...
def test_generar_reporte_completo_integration():
    ...
    arapcs = [
        {
            "IDAccionRealizada": 1,
            "CodigoNoConformidad": "A1",
            "AccionRealizada": "AR",
            "Responsable": "R",
            "FechaFinPrevista": now + datetime.timedelta(days=10),
        }
    ]
    ncs_caducar = [
        {
            "CodigoNoConformidad": "C1",
            "Nemotecnico": "NC",
            "DESCRIPCION": "DC",
            "RESPONSABLECALIDAD": "RC",
            "FECHAAPERTURA": now,
    ...
    ncs_sin_acciones = [
        {
            "CodigoNoConformidad": "S1",
            "Nemotecnico": "NS",
            "DESCRIPCION": "DS",
            "RESPONSABLECALIDAD": "RC",
            "FechaApertura": now,
            "FechaPrevistaCierre": now,
        }
    ]
    html = gen.generar_reporte_completo(
        ncs_eficacia, arapcs, ncs_caducar, ncs_sin_acciones, titulo="Reporte X"
    )
    assert (
        "Reporte X" in html
        and "Resumen Ejecutivo" in html
        and "Acciones Correctivas/Preventivas Próximas a Vencer" in html
    )
    ...
    data = [
        {
            ...
            "DESCRIPCION": "Desc1",
            "RESPONSABLECALIDAD": "Resp",
            "FECHACIERRE": datetime.datetime(2025, 1, 1),
            "DiasParaCaducar": -2,
        },
        {
            "CodigoNoConformidad": "NC2",
            "DESCRIPCION": "Desc2",
            "RESPONSABLECALIDAD": "Resp",
            "FECHACIERRE": datetime.datetime(2025, 1, 2),
            "DiasParaCaducar": 0,
        },
        {
            "CodigoNoConformidad": "NC3",
            "DESCRIPCION": "Desc3",
            "RESPONSABLECALIDAD": "Resp",
            "FECHACIERRE": datetime.datetime(2025, 1, 3),
            "DiasParaCaducar": 4,
        },
        {
            "CodigoNoConformidad": "NC4",
            "DESCRIPCION": "Desc4",
            "RESPONSABLECALIDAD": "Resp",
            "FECHACIERRE": datetime.datetime(2025, 1, 4),
            "DiasParaCaducar": 10,
        },
    ]
    headers = [
