...
class TestCorreoTareasManager:
    ...
    @patch('correo_tareas.correo_tareas_manager._Path')
    ...
    def test_process_pending_emails_no_pending(self, correo_tareas_manager):
        """Test process_pending_emails sin correos pendientes"""
        # Arrange
        correo_tareas_manager.obtener_correos_pendientes = Mock(return_value=[])

        # Act
        result = correo_tareas_manager.process_pending_emails()

        # Assert
        assert result == 0
    
    def test_process_pending_emails_with_pending(self, correo_tareas_manager):
        """Test process_pending_emails con correos pendientes"""
        # Arrange
        mock_correos = [
    ...
    # Eliminados tests de execute_continuous_task / execute_daily_task tras refactor
