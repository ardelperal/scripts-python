...
def test_economy_mixed():
    ...
    fact={"NFactura":"F1","NDocumento":"N","CODPROYECTOS":"D2","PETICIONARIO":"P2","EXPEDIENTE":"E2","DESCRIPCION":"D2","IMPORTESINIVA":100,"Suministrador":"S","ImporteFactura":50}
    html=build_mgr([[row1],[],[fact],[]]).generate_economy_report_html()
    assert 'DPDs fin agenda técnica pendientes recepción' in html and 'Facturas rechazadas' in html
