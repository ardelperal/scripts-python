...
project_root = os.path.dirname(os.path.dirname(current_dir))  # subir de unit -> tests -> root
...
def test_reporte_calidad_moderno_con_datos():
    gen = HTMLReportGenerator()
    ars = [{
        'CodigoNoConformidad':'NC001','Nemotecnico':'NEMO','DESCRIPCION':'Desc','RESPONSABLECALIDAD':'Resp',
        'FECHAAPERTURA':'2025-08-01','FPREVCIERRE':'2025-08-20','DiasParaCierre':5
    }]
...
def test_reporte_tecnico_moderno():
    gen = HTMLReportGenerator()
    ars15 = [{
        'CodigoNoConformidad':'NC002','Nemotecnico':'NM','AccionCorrectiva':'Acción','AccionRealizada':'Tarea',
        'FechaInicio':'2025-08-01','FechaFinPrevista':'2025-08-25','Nombre':'Tec','DiasParaCaducar':10,'CorreoCalidad':'calidad@example.com'
    }]
