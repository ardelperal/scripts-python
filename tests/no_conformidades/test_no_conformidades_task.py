...
class TestNoConformidadesTaskExecuteSpecificLogic(unittest.TestCase):
    ...
    def test_solo_calidad(self, mock_debe_calidad, mock_debe_tecnica, mock_logica_calidad, mock_logica_tecnica):
    ...
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_tecnica')
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_calidad')
    def test_solo_tecnica(self, mock_debe_calidad, mock_debe_tecnica, mock_logica_calidad, mock_logica_tecnica):
    ...
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_tecnica')
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_calidad')
    def test_ambas(self, mock_debe_calidad, mock_debe_tecnica, mock_logica_calidad, mock_logica_tecnica):
        mock_debe_calidad.return_value = True
        mock_debe_tecnica.return_value = True
        mock_logica_calidad.return_value = True
        mock_logica_tecnica.return_value = True
    ...
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_tecnica')
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_calidad')
    def test_ninguna(self, mock_debe_calidad, mock_debe_tecnica, mock_logica_calidad, mock_logica_tecnica):
        mock_debe_calidad.return_value = False
        mock_debe_tecnica.return_value = False
    ...
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_tecnica')
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_calidad')
    def test_excepcion_en_calidad(self, mock_debe_calidad, mock_debe_tecnica, mock_logica_calidad, mock_logica_tecnica):
        mock_debe_calidad.return_value = True
        mock_debe_tecnica.return_value = False
    ...
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_tecnica')
    @patch.object(NoConformidadesTask, 'debe_ejecutar_tarea_calidad')
    def test_execute_logic_with_technical_exception(self, mock_debe_calidad, mock_debe_tecnica, mock_logica_calidad, mock_logica_tecnica):
