...
class TestNoConformidadesManagerModern(unittest.TestCase):
    ...
    def test_modern_technical_report_html(self):
        ars_15 = [{
            'CodigoNoConformidad': 'NC-1', 'Nemotecnico': 'TEC1', 'AccionCorrectiva': 'Acción',
            'AccionRealizada': 'Tarea', 'FechaInicio': '2024-01-01', 'FechaFinPrevista': '2024-01-10',
            'Nombre': 'Tecnico 1', 'DiasParaCaducar': 5, 'CorreoCalidad': 'calidad@example.com'
        }]
        html = self.manager.html_generator.generar_reporte_tecnico_moderno(ars_15, [], [])
    ...
    def test_modern_quality_report_html(self):
        ncs_eficacia = [{
            'CodigoNoConformidad': 'NC-2', 'Nemotecnico': 'TEC2', 'DESCRIPCION': 'Desc',
            'RESPONSABLECALIDAD': 'Resp', 'FECHACIERRE': '2024-01-05',
            'FechaPrevistaControlEficacia': '2024-01-20', 'Dias': 10
        }]
