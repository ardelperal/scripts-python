...
class TestBrassDatabaseIntegration:
    ...
    def test_database_connectivity(self, local_brass_manager):
        ...
        result_brass = local_brass_manager.db.execute_query(
        ...
        result_tareas = local_brass_manager.tareas_db.execute_query(
    ...
    def test_equipos_structure(self, local_brass_manager):
        ...
        if result:
            ...
            for field in expected_fields:
                assert (
                    field in equipo
                ), f"Campo {field} no encontrado en TbEquiposMedida"
    ...
    def test_calibraciones_structure(self, local_brass_manager):
        ...
        if result:
            ...
            for field in expected_fields:
                assert (
                    field in calibracion
                ), f"Campo {field} no encontrado en TbEquiposMedidaCalibraciones"
