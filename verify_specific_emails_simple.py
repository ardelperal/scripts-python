#!/usr/bin/env python3
"""
Script simple para verificar el estado de correos específicos
"""
...
def verificar_correos_especificos():
    ...
    print("=== VERIFICACIÓN SIMPLE DE CORREOS ===")
    ...
    try:
        ...
        if enviados:
            ...
            for correo in enviados[:10]:  # Limitar a 10 en Python en lugar de SQL
